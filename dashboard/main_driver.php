				...
				<div class="card">
					<div class="card-body">
						<form class="xform" id="admin_form" method="post">
							<header><?php echo $lang['edit-clien52'] ?><span><?php echo $lang['edit-clien53'] ?> <i class="icon-double-angle-right"></i> <?php echo $row->username;?></span></header>
							<div class="row">
							...
							<div class="row">
								<section class="col col-4">
								  <label class="input"> <i class="icon-prepend icon-truck"></i>
									<input type="text" name="enrollment" value="<?php echo $row->enrollment;?>" placeholder="<?php echo $lang['edit-clien59'] ?>">
								  </label>
								  <div class="note note-error"><?php echo $lang['edit-clien59'] ?></div>
								</section>
								<section class="col col-4">
								  <label class="input"> <i class="icon-prepend icon-tag"></i>
									<input type="text" name="vehiclecode" value="<?php echo $row->vehiclecode;?>" placeholder="<?php echo $lang['edit-clien60'] ?>">
								  </label>
								  <div class="note note-error"><?php echo $lang['edit-clien60'] ?></div>
								</section>
							</div>
							</br></br></br>
							<hr>
							<div class="row">
								<section class="col col-4">
									...
									<div class="note"><?php echo $lang['edit-clien55'] ?> <i class="icon-exclamation-sign  tooltip" data-title=""></i></div>
								</section>
								<section class="col col-5">
									...
									<div class="note"><?php echo $lang['edit-clien56'] ?></div>
								</section>
								<section class="col col-3">
									<div class="inline-group">
										<label class="radio">
							...
							<div class="row">
								<section class="col col-4">
									...
									<div class="note"><?php echo $lang['edit-clien58'] ?></div>
								</section>
							...
							<footer>
								<button class="button" name="dosubmit" type="submit"><?php echo $lang['edit-clien57'] ?><span><i class="icon-ok"></i></span></button>
								<a href="driver.php?do=main_driver" class="button button-secondary"><span><i class="ti-share-alt"></i></span> <?php echo $lang['edit-clien30'] ?></a> 
							</footer>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form class="xform" id="admin_form" method="post">
							<header><?php echo $lang['edit-clien52'] ?><span><?php echo $lang['edit-clien53'] ?></span></header>
							<div class="row">
								<section class="col col-6">
							...
							<div class="row">
								<section class="col col-3">
									<label class="input">
										<input name="code_phone" list="browser" autocomplete="off" placeholder="Select Code Phone" required="required">	
										<datalist id="browser">
							...
							<div class="row">
								<section class="col col-4">
								  <label class="input">
									<input type="text" name="enrollment"  placeholder="<?php echo $lang['edit-clien59'] ?>">
								  </label>
								  <div class="note note-error"><?php echo $lang['edit-clien59'] ?></div>
								</section>
								<section class="col col-4">
								  <label class="input">
									<input type="text" name="vehiclecode"  placeholder="<?php echo $lang['edit-clien60'] ?>">
								  </label>
								  <div class="note note-error"><?php echo $lang['edit-clien60'] ?></div>
								</section>
							</div>
							...
							<div class="row">
								...
								<section class="col col-3">
									...
									<div class="note note-info"><?php echo $lang['edit-clien54'] ?></div>
								</section>
							</div>
							<div class="row">
								<section class="col col-12">
							...
							<footer>
								<button class="button" name="dosubmit" type="submit"><?php echo $lang['edit-clien51'] ?><span><i class="icon-ok"></i></span></button>
								<a href="driver.php?do=main_driver" class="button button-secondary"><span><i class="ti-share-alt"></i></span> <?php echo $lang['edit-clien30'] ?></a> 
							</footer>
							</form>
					</div>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center">
									<a href="driver.php?do=newsletter&amp;emailid=<?php echo urlencode($row->email);?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline" data-toggle="tooltip" data-original-title="<?php echo $lang['edit-clien45'] ?>"><i class="ti-email" aria-hidden="true"></i></button></a>
									<a href="driver.php?do=main_driver&amp;action=edit&amp;id=<?php echo $row->id;?>" ><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline" data-toggle="tooltip" data-original-title="<?php echo $lang['edit-clien46'] ?>"><i class="ti-pencil" aria-hidden="true"></i></button></a>	
									<?php if($row->id == 1):?>
