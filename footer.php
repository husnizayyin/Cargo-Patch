		...
		<div class="row">
			...
			<div class="col-lg-2 col-md-6 ml-auto mb-5 mb-lg-0">
				...
				<ul class="list-unstyled u-lh-2 text-footer">
					...
					<li><a href="shipping-rates.php">Cek Ongkir </a> </li>	
					<li><a href="login.php">Login </a> </li>	
							
				</ul>
			</div>		
			<div class="col-lg-2 col-md-6 ml-auto mb-5 mb-lg-0">
				<h4 class="text-white">PO.Budiman</h4>
				<div class="u-h-4 u-w-50 bg-primary rounded mt-3 u-mb-20"></div>
				<ul class="list-unstyled u-lh-2 text-footer">
			...
			<div class="col-lg-3 col-md-6 ml-auto mb-5 mb-lg-0">
				...
				<ul class="list-unstyled">
					<li class="mb-2">
						<span class="icon icon-Phone2 text-primary mr-2"></span> <a href="t.me/husnizayyin" class="text-footer">Telegram</a>
					</li>
					<li class="mb-2">
					...
					<li class="mb-2">
						<span class="icon icon-Pointer text-primary mr-2"></span> <a href="" class="text-footer">Jln.Ir.H.Juanda No.31, Indihiang, Kota Tasikmalaya</a>
					</li>
				</ul>
