						...
						<div class="example">
							...
							<form id="dForm" method="post" style="padding:0;">
								<div class="input-daterange input-group" id="date-range">
									...
									&nbsp;
										<span class="input-group-text bg-info b-0 text-white"><?php echo $lang['langs_086'] ?></span>
									&nbsp;
									<input class="form-control" id="bd-until"  placeholder="To Date" width="276" />
									&nbsp;&nbsp;
									<div class="input-group-append">
										<a target="_blank" href="javascript:consolidatedeliveredPDF();"><img src="assets/images/pdf.png" alt="x" border="0" height="43" width="38" /></a>
									</div>
								</div>
							</form>	
						</div>
...
<script src="dist/js/print_concolidatedelivered.js"></script>
