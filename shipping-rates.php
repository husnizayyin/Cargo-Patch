  ...
  <div class="container">
    <div class="row">
    	<div class="col-12 text-center text-white">
    		<h1 class="text-white">HITUNG ONGKOS KIRIM DISINI</h1>
    		<div class="u-h-4 u-w-50 bg-white rounded mx-auto my-4"></div>
    		<p class="lead">
    			DIJAMIN PAKET ANDA CEPAT SAMPAI
    		</p>
    	</div>
    </div> <!-- END row-->
  </div> <!-- END container-->
		...
		<div class="col-lg-12 ml-auto mt-5 mb-4">
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" accept-charset="utf-8">
				<div class="row">
					...
					<div class="col-md-4 parcel_country">
						<div class="form-group">
							...
							<input type="text" class="form-control"  name="scountry" id="ReceiptCountryId" placeholder="Pilih Kota Tujuan" list="browsers" autocomplete="off" required="required">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="form-group">
							<button type="submit" class="btn btn btn-rounded btn-primary m-3 px-md-5 pull-right" name="submit"><i class="fa fa-cube mr-1"></i> Cek Ongkir</button>
						</div>	
					</div>
				</div>	
			</form>	
