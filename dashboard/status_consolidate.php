...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
						...
						<div class="card">
							<div class="card-body">
								...
								<form class="xform" id="admin_form" method="post">
									<header><h4 class="modal-title"><?php echo $lang['status-ship2'] ?> <?php echo $row->order_inv;?> </h4> <?php echo $lang['status-ship3'] ?> <?php echo $row->r_dest;?> | <?php echo $row->c_address;?></header>
									...
									<div class="row">
										<div class="col-sm-12 col-md-6">
											...
											<textarea class="form-control" id="message-text" placeholder="Details of change status...." name="comments"></textarea>
										</div>
										<div class="col-sm-12 col-md-3">
											<div class="form-group"> 
												<label for="inputcontact" class="control-label col-form-label"><?php echo $lang['langs_01023'] ?></label> 
									...
									<footer>
										...
										<a href="consolidate.php?do=list_consolidate" class="button button-secondary"><span><i class="ti-share-alt"></i></span> <?php echo $lang['status-ship11'] ?></a> 
									</footer>
								</form>
							</div>
						</div>
			...
			<?php echo Core::doForm("processStatusConsolidate");?> 
			<?php break;?>
			<?php endswitch;?>
