			...
			<tbody>
				<tr>
					<td>						
						...
						<?php echo $row->collection_courier; ?>
						<hr />
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<p style="text-align: left; "><strong>&nbsp;&nbsp;&nbsp;<?php echo $row->r_address; ?> - <?php echo $lang['inv-label3'] ?>:<?php echo $row->r_postal; ?></strong></p>
										<p style="text-align: left;"><font size=5><strong>&nbsp;&nbsp;<?php echo $row->r_dest." | ".$row->r_city; ?></strong></font></p>
									</td></font>
								</tr>
							</tbody>
						</table>
					  ...
					  <table style="text-align: center;" width="100%">
							<tbody>
								...
								<tr>
									<td width="50%">
										<p><font size=4><?php echo $row->r_qnty; ?> | <?php if ($row->r_weight > $row->v_weight) { echo  round_out($row->r_weight); } else { echo round_out($row->v_weight); }?></font></p>
									</td>
									<td width="50%">
										<p><font size=4><?php echo $row->itemcat; ?></font></br><font size=4><?php echo $row->r_description; ?></font></p>
									</td>
								</tr>
						  </tbody>
					  </table>
